...
curl -X POST -H "Content-Type: application/json" -d "pi_data[ping]=${value1}" -d "pi_data[download]=${value2}" -d "pi_data[upload]=${value3}" https://dude-whats-my-speed.herokuapp.com/rasberry_pis/index
